            ...
            <PageBox>
                <Box>
                    <div className="flex flex-col">
                        {
                            clubAthleteData.sort((a, b) => (a.trailtour_position != null ? a.trailtour_position : -Infinity) - (b.trailtour_position != null ? b.trailtour_position : -Infinity)).map((row, index) => {
